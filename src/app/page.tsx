      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-md border border-slate-200 bg-white p-8">
              <Image
              ...
              />
              <div className="absolute inset-x-8 bottom-8 rounded-md bg-slate-950/85 p-5 text-white">
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              <div className="overflow-hidden rounded-md bg-slate-900 p-8 text-white">
                <Image
        ...
        <section className="mx-auto max-w-7xl px-6 py-8 sm:px-8 lg:px-12">
          <div className="overflow-hidden rounded-md border border-slate-200 bg-slate-900 p-8 text-white">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="rounded-md border border-white/20 bg-slate-950/40 p-6">
                <div className="relative h-56 rounded-md border border-white/10 bg-slate-800">
                  <div className="absolute left-[18%] top-[30%] h-3 w-3 rounded-full bg-sky-300" />
                  <div className="absolute left-[48%] top-[42%] h-3 w-3 rounded-full bg-emerald-400" />
                  <div className="absolute left-[72%] top-[26%] h-3 w-3 rounded-full bg-white" />
                  <div className="absolute bottom-6 left-6 rounded-md bg-slate-950/85 p-4 text-sm text-slate-200">
        ...
        <section className="bg-sky-950 py-20 text-white">
          <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            <div className="flex flex-col gap-8 rounded-md border border-white/10 bg-white/10 p-8 lg:flex-row lg:items-center lg:justify-between">
